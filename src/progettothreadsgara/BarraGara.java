...
public class BarraGara extends JPanel {
     ...
     * In NetBeans: metti i file in src/Immagini/ → vengono copiati nel classpath.
     *
     * Se l'immagine non esiste, immagineMacchina rimane null
     * e verrà usata una sagoma colorata di riserva.
     *
     ...
     * DEVE usare invokeLater() perché viene chiamato dai thread delle macchine,
     * non dall'EDT di Swing.
     *
    ...
    /**
     * Sagoma di riserva usata se l'immagine reale non è disponibile.
     * Disegna una semplice macchina stilizzata con Graphics2D.
     *
     * Per sostituire con un'immagine esterna:
     *   Image img = ImageIO.read(new File("percorso/auto.png"));
